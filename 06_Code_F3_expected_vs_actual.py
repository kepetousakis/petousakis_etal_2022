...
try:
	filename_ref  = './Data_F3_expectation_lines.pickle'
	...
	for idx_c, cnd in enumerate(_CNDS):
		filename_avgs = f'{_LOCALPATH}/cnd{cnd}_noise{cnd}_neuron_disparity_rates_filtered.pickle'
		...
		plt.xlabel('User-defined disparity', fontsize=18)
		plt.ylabel('Neuronal orientation preference', fontsize=18)
