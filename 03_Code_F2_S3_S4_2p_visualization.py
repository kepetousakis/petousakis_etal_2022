...
if os.path.exists(f'./Data_F2_bins_2p.pickle') and os.path.exists(f'./Data_F2_distribution_2p.pickle'):
	x_d = util.pickle_load(f'./Data_F2_bins_2p.pickle')
	distr_all_d = util.pickle_load(f'./Data_F2_distribution_2p.pickle')
else:
	raise IOError
...
#%% Figure 2D
[aggregate_somata, aggregate_dendrites, averaged_somata, averaged_dendrites, n_somata, n_dendrites, err_somata, err_dendrites] = util.pickle_load('./Data_F2_allcells_STA.pickle')
window_left = 5
window_right = 10
...
#%% Supp.Figure 3B
[aggregate_somata, aggregate_dendrites, averaged_somata, averaged_dendrites, n_somata, n_dendrites, err_somata, err_dendrites] = util.pickle_load('./Data_F2_mouse1_STA.pickle')
fig = plt.figure()
plt.suptitle('Supp.Figure 3B')
plt.subplot(211)
for i in range(0,len(aggregate_somata)):
	plt.plot(aggregate_somata[i][:], c='b', alpha=i/len(aggregate_somata))
plt.title('Somatic events')
...
#%% Supp.Figure 3C
[aggregate_somata, aggregate_dendrites, averaged_somata, averaged_dendrites, n_somata, n_dendrites, err_somata, err_dendrites] = util.pickle_load('./Data_F2_mouse2_STA.pickle')
fig = plt.figure()
plt.suptitle('Supp.Figure 3C')
plt.subplot(211)
for i in range(0,len(aggregate_somata)):
	plt.plot(aggregate_somata[i][:], c='b', alpha=i/len(aggregate_somata))
plt.title('Somatic events')
...
if os.path.exists(f'./Data_S4_bins_null.pickle') and os.path.exists(f'./Data_S4_distribution_null.pickle'):
	x_d = util.pickle_load(f'./Data_S4_bins_null.pickle')
	distr_all_d = util.pickle_load(f'./Data_S4_distribution_null.pickle')
else:
	raise IOError
